...
var DOCS = [
  ...
  { id: "landscape", title: "Landscape (the repository)", html:
    ...
    + "<p><b>Large models</b> (like an imported Microsoft catalog with thousands of processes) stay navigable: the process list and Landscape collapse to domain headers and are driven by <b>search</b> — type in the box to filter across everything — and the Architecture tree expands one level at a time. Nothing paints thousands of items at once.</p>" },
